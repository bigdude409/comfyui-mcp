...
# Pack: LTX-2.3 — 3-stage distill I2V/T2V  (Linux / RunPod)
...
echo "-------- models --------"
grab "models/diffusion_models/ltx-2-3-22b-dev_transformer_only_fp8_input_scaled.safetensors" "https://huggingface.co/Kijai/LTX2.3_comfy/resolve/main/diffusion_models/ltx-2-3-22b-dev_transformer_only_fp8_input_scaled.safetensors"
grab "models/text_encoders/gemma_3_12B_it.safetensors" "https://huggingface.co/Comfy-Org/ltx-2/resolve/main/split_files/text_encoders/gemma_3_12B_it.safetensors"
